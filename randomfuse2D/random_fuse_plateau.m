...
L_vec = [100]; 
dist_vals = [5e-1, 1e-1, 5e-2, 1e-2, 5e-3, 1e-3, 5e-4, 1e-4]; 
...
for L = L_vec
    ...
    for runs = 1 : Nsamples 
        ...
        for dist = dist_vals
            ...
            filename = ['/Users/ivan_bonamassa/Desktop/random_fuse/fuse_plateau/G_t_L', num2str(L), 'Ic_delta', num2str(dist), '_plateau.mat'];
            save(filename, 'G_evo');
